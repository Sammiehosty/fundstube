              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-wrap gap-3">
                  <button 
                    ...
                    className="px-7 py-3.5 bg-blue-600 text-white rounded-xl font-bold text-sm hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/10 flex items-center gap-2"
                  >
                    <ArrowUpRight size={18} /> Withdraw Funds
                  </button>
                  <button 
                    onClick={() => setShowAdsHistory(true)}
                    className="px-7 py-3.5 bg-white/5 border border-white/10 text-slate-300 rounded-xl font-bold text-sm hover:bg-white/10 transition-all flex items-center gap-2"
                  >
